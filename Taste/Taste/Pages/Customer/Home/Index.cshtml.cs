...
namespace Taste.Pages.Customer.Home
{
    public class IndexModel : PageModel
    {
       ...
       //kullanıcının sepete eklediklerini çıkış yapınca tutuyor Session 
        if (claim != null)
            {
                int shoppingCartCount = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == claim.Value)
                    .ToList().Count;
